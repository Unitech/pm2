...
commander.version(pkg.version)
  ...
  .option('--disable-source-map-support', 'disable source map support')
...
commander.command('ports')
  .description('display process list with port information')
  .action(function() {
    pm2.ports(commander)
  });
...
commander.command('monit')
  .option('--lines <n>', 'number of log lines to display per process (default: 200)')
  .description('launch termcaps monitoring')
  .action(function(cmd) {
    pm2.dashboard({ lines: cmd.lines });
  });
