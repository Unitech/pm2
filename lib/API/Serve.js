...
var options = {
  port: process.env.SERVE_PORT || process.argv[3] || 8080,
  path: process.env.SERVE_PATH || process.argv[2] || '.'
};
...
http.createServer(function (request, response) {
  ...
  // since we call filesystem directly, its safer to forbid '..' in url
  ...
  if (file === '/' || file === '') {
    filePath = options.path + '/index.html';
  }
