    ...
    that.Client.getProcessByNameOrId(process_name, function (err, processes) {
      ...
      require('vizion').update({
        ...
        if (meta.success === true) {
          ...
          printOut(cst.PREFIX_MSG + 'Already up-to-date or an error occurred for app: %s', process_name);
          ...
          require('vizion').revertTo(
            ...
            function(err2, meta2) {
              if (!err2 && meta2.success) {
                ...
                printOut(cst.PREFIX_MSG + 'Already up-to-date or an error occurred: %s', process_name);
