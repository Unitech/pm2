...
module.exports = function(God) {
  ...
  /**
   * Get formated process by id
   * @method getFormatedProcess
   * @return {Array} formated process
   */
  God.getFormatedProcess = function getFormatedProcess(id) {
  ...
  God.getFormatedProcesses = function getFormatedProcesses() {
    ...
    Object.keys(God.clusters_db).forEach(id => {
      ...
      if (God.clusters_db[id] && !isNaN(God.clusters_db[id].pm2_env.pm_id)) {
        arr.push(God.getFormatedProcess(id));
      }
    });
    return arr;
  };
