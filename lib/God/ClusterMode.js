...
module.exports = function ClusterMode(God) {
  ...
  God.nodeApp = function nodeApp(env_copy, cb){
    ...
    try {
      ...
      // update(30.08.2017): copy parameters required on startup node instance such as NODE_EXTRA_CA_CERTS
      // NODE_EXTRA_CA_CERTS - read only when startup node instance
      clu = cluster.fork({pm2_env: JSON.stringify(env_copy), NODE_EXTRA_CA_CERTS: env_copy.NODE_EXTRA_CA_CERTS});
    } catch(e) {
