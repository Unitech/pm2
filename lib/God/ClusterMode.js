...
module.exports = function(God) {
  ...
  God.nodeApp = function(pm2_env, cb){
    ...
    if (fs.existsSync(pm2_env.pm_exec_path) == false) {
      ...
      return cb(God.logAndGenerateError('Script ' + pm2_env.pm_exec_path + ' missing'), {});
    }

    console.log('Entering in node wrap logic (cluster_mode) for script %s', pm2_env.pm_exec_path);
