...
module.exports = function(God) {
  ...
  God.stopProcessId = function(id, cb) {
    ...
    if (proc.pm2_env.exec_mode == 'cluster_mode' &&
      ...
      console.error('- CLUSTER LOGIC -');
      console.error('EXEC MODE:', proc.pm2_env.exec_mode);
      console.error('STATE:', proc.state);
      console.error('SUICIDE:', proc.suicide);
      console.error('PROC STATUS:', proc.pm2_env.status);
      ...
      timeout = setTimeout(function() {
        ...
        proc.removeAllListeners('disconnect');
        kill_anyway(proc);
      }, 800);
      ...
      setTimeout(function() {
        try {
          console.error('STATE:', proc.state);
          console.error('SUICIDE:', proc.suicide);
          console.error('EXIT CODE:', proc.process.exitCode);
          console.error('EXIT SIGNAL:', proc.process.signalCode);
          console.error('PROC STATUS:', proc.pm2_env.status);
