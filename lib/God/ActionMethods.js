...
module.exports = function(God) {
   ...
   */
  God.stopWatch = function(env, method, fn) {

    switch(method) {
      case 'stopProcessId':
        God.clusters_db[env].pm2_env.watch = false;
        break;
      case 'stopProcessName':
        God.clusters_db[God.findByName(env)].pm2_env.watch = false;
        break;
      case 'stopAll':
        var processes = God.getFormatedProcesses(), l = processes.length;
        while(l--)
          processes[l].pm2_env.watch = false;
        break;
      default:
        break;
    }
   ...
   */
  God.restartWatch = function(env, method, fn) {

    switch(method) {
      case 'restartProcessId':
        env = God.clusters_db[env].pm2_env;
        env.watch = !env.watch;
        break;
      case 'restartProcessName':
        env = God.clusters_db[God.findByName(env)].pm2_env;
        env.watch = !env.watch;
        break;
      default:
        break;
