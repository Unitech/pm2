...
You can check the content of the ecosystem.config.js on how to start multiple instances of the same HTTP application in order to get the most from your working system.
