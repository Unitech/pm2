...
const DockerMgmt  = require('./API/ExtraMgmt/Docker.js')
const conf        = require('../constants.js');
const Client      = require('./Client');
const Common      = require('./Common');
const KMDaemon    = require('@pm2/agent/src/InteractorClient');
const Config      = require('./tools/Config');
const Modularizer = require('./API/Modules/Modularizer.js');
const path_structure = require('../paths.js');
const UX          = require('./API/UX');
const pkg         = require('../package.json');
const hf = require('./API/Modules/flagExt.js');
...
////////////////////////////
  ...
  _startScript (script, opts, cb) {
    ...
    if (opts.watchDelay) {
      if (typeof opts.watchDelay === "string" && opts.watchDelay.includes("ms"))
