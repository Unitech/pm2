...
API.prototype._startJson = function(file, opts, action, pipe, cb) {
  ...
  appConf.forEach(function(app) {
    ...
    if (opts.watch) app.watch = true;
    if (opts.ignore_watch) app.ignore_watch = opts.ignore_watch;
    if (opts.instances) app.instances = opts.instances;
...
API.prototype._restart = function(cmd, envs, cb) {
  var that = this;
