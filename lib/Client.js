...
Client.prototype.executeRemote = function executeRemote(method, env, fn) {
  ...
  if ((util.isArray(env_watch) && env_watch.length === 0) ||
      (typeof(env_watch) === 'boolean') && env_watch == false) {
    env_watch = !!~process.argv.indexOf('--watch') || env_watch;
  }
  ...
  if (!this.client || !this.client.call) {
    this.start(function(error) {
      ...
      return self.client.call(method, env, fn);
    });
    return false;
  }
