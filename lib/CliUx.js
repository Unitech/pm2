...
UX.dispAsTable = function(list, interact_infos) {
 ...
 var args_table = new Table({
  ...
  list.forEach(function(l) {
    ...
    var argsobj = {};
		var command = l.pm2_env.pm_exec_path;
    var args = l.pm2_env.args ? l.pm2_env.args : 'none';
  ...
  console.log(args_table.toString());
