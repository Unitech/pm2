 ...
 * @param {Object} env environment to be passed to the process
...
God.injectVariables = function injectVariables (env, cb) {
  ...
  if (env.increment_var) {
    ...
    var default = Number(env.env[env.increment_var]) || 0;
    env[env.increment_var] = typeof lastIncrement === 'undefined' ? default : lastIncrement + 1;
