...
(function hackConsole(){
  console.log('format', process.env.PM2_LOG_DATE_FORMAT, typeof process.env.PM2_LOG_DATE_FORMAT, cst.PM2_LOG_DATE_FORMAT, typeof cst.PM2_LOG_DATE_FORMAT == 'string');
