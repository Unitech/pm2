...
Interactor.autoDaemonize = function() {
  ...
  REVERSE_INTERACT = process.env.PM2_REVERSE_INTERACT;
...
var Filter = {
   ...
   * @method filter_process_state_change
   * @param {} data
   * @return state
   */
...
if (require.main === module) {
  ...
  d.run(Interactor.autoDaemonize);
}
