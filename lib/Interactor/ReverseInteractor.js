...
var PM2_REMOTE_METHOD_ALLOWED = {
  ...
  'install'        : { password : true },

  'pullAndRestart' : { password : true, optional : true },
  'forward'        : { password : true, optional : true },
  'backward'       : { password : true, optional : true },
  'stop'           : { password : true },
  'delete'         : { password : true },
  'updatePM2'      : { password : true },
