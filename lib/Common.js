...
Common.printVersion = function() {
  ...
  if (process.argv.includes('-v') && process.argv.indexOf('-v') < variadicArgsDashesPos) {
...
Common.verifyConfs = function(appConfs) {
  ...
  for (var i = 0; i < appConfs.length; i++) {
     ...
     */
    if (app.script && app.script.includes(' ') && cst.IS_WINDOWS === false) {
